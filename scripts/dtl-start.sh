...
export DATA_TRANSPORT_LAYER__L1_RPC_USER=$DATA_TRANSPORT_LAYER__RPC_USER
export DATA_TRANSPORT_LAYER__L1_RPC_PASSWORD=$DATA_TRANSPORT_LAYER__RPC_PASSWORD
export DATA_TRANSPORT_LAYER__L2_RPC_ENDPOINT=$DATA_TRANSPORT_LAYER__RPC_ENDPOINT
export DATA_TRANSPORT_LAYER__L2_RPC_USER=$DATA_TRANSPORT_LAYER__RPC_USER
export DATA_TRANSPORT_LAYER__L2_RPC_PASSWORD=$DATA_TRANSPORT_LAYER__RPC_PASSWORD
